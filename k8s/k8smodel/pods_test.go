...
func TestK8pUnmarshal(t *testing.T) {
	var jsons = `{
  "kind": "PodList",
  "apiVersion": "v1",
  "metadata": {
    "selfLink": "/api/v1/namespaces/devenv/pods",
    "resourceVersion": "5370870961"
  },
  "items": [
    {
      "metadata": {
    ...
    {
      "metadata": {
        "name": "test1-3859283352-1g2q4",
        "generateName": "test1-3859283352-",
        "namespace": "devenv",
        "selfLink": "/api/v1/namespaces/devenv/pods/test1-3859283352-1g2q4",
        "uid": "d384f712-fc35-11e7-a645-52540018543c",
        "resourceVersion": "5346048730",
        "creationTimestamp": "2018-01-18T09:56:17Z",
        "labels": {
          "pod-template-hash": "3859283352",
          "qcloud-app": "test1",
          "qcloud-redeploy-timestamp": "1516269377"
        },
        "annotations": {
          "kubernetes.io/created-by": "{\"kind\":\"SerializedReference\",\"apiVersion\":\"v1\",\"reference\":{\"kind\":\"ReplicaSet\",\"namespace\":\"devenv\",\"name\":\"test1-3859283352\",\"uid\":\"d3835092-fc35-11e7-a645-52540018543c\",\"apiVersion\":\"extensions\",\"resourceVersion\":\"5346031196\"}}\n"
        },
        "ownerReferences": [
          {
            "apiVersion": "extensions/v1beta1",
            "kind": "ReplicaSet",
            "name": "test1-3859283352",
            "uid": "d3835092-fc35-11e7-a645-52540018543c",
            "controller": true,
            "blockOwnerDeletion": true
          }
        ]
      ...
      "status": {
        ...
        "conditions": [
          {
            ...
            "status": "True",
            "lastProbeTime": null,
            "lastTransitionTime": "2018-01-18T09:56:17Z"
          },
          {
            "type": "Ready",
            "status": "True",
            "lastProbeTime": null,
            "lastTransitionTime": "2018-01-18T09:56:57Z"
          },
          {
            "type": "PodScheduled",
            "status": "True",
        ...
        "hostIP": "192.168.1.5",
        "podIP": "172.16.2.183",
        "startTime": "2018-01-18T09:56:17Z",
        "containerStatuses": [
          {
            "name": "eqxiu-base-server",
            "state": {
              "running": {
                "startedAt": "2018-01-18T09:56:18Z"
              }
            },
            "lastState": {},
            "ready": true,
            ...
            "containerID": "docker://8620e0050c8ea14f69e07aca64dabe712d0b0af8497b614715a783e116a23d4d"
          }
        ],
        "qosClass": "BestEffort"
      }
    ...
    {
      "metadata": {
        "name": "test1-3859283352-4sm8w",
        "generateName": "test1-3859283352-",
        "namespace": "devenv",
        "selfLink": "/api/v1/namespaces/devenv/pods/test1-3859283352-4sm8w",
        "uid": "eb66f5a2-fc35-11e7-a645-52540018543c",
        "resourceVersion": "5346066776",
        "creationTimestamp": "2018-01-18T09:56:57Z",
        "labels": {
          "pod-template-hash": "3859283352",
          "qcloud-app": "test1",
          "qcloud-redeploy-timestamp": "1516269377"
        ...
        "annotations": {
          "kubernetes.io/created-by": "{\"kind\":\"SerializedReference\",\"apiVersion\":\"v1\",\"reference\":{\"kind\":\"ReplicaSet\",\"namespace\":\"devenv\",\"name\":\"test1-3859283352\",\"uid\":\"d3835092-fc35-11e7-a645-52540018543c\",\"apiVersion\":\"extensions\",\"resourceVersion\":\"5346048748\"}}\n"
        },
        "ownerReferences": [
          {
            "apiVersion": "extensions/v1beta1",
      ...
      "status": {
        ...
        "conditions": [
          ...
          },
          {
            ...
            "status": "True",
            "lastProbeTime": null,
            "lastTransitionTime": "2018-01-18T09:57:37Z"
          },
          {
            "type": "PodScheduled",
            "status": "True",
        ...
        "hostIP": "192.168.1.15",
        "podIP": "172.16.0.128",
        "startTime": "2018-01-18T09:56:57Z",
        "containerStatuses": [
          {
            "name": "eqxiu-base-server",
            "state": {
              "running": {
                "startedAt": "2018-01-18T09:56:59Z"
              }
            },
            "lastState": {},
            "ready": true,
            ...
            "image": "ccr.ccs.tencentyun.com/eqxiu/eqxiu-base-server:1.1.1",
            "imageID": "docker-pullable://ccr.ccs.tencentyun.com/eqxiu/eqxiu-base-server@sha256:687f74f6de750e1ead38f24c88fb337b3b6923b965bea77c68617943776d27fc",
            "containerID": "docker://f53aa8f3771def4565b6d5fddb11f52a50389135eb8e00161f22d4abf496fb06"
          }
        ],
        "qosClass": "BestEffort"
      }
...
,"kind": "Deployment",
  ...
  "status": {
	...
	k8p, err := K8pUnmarshal([]byte(jsons))
	assert.Nil(t, err)
	assert.Equal(t, 13, len(k8p.Items))
	assert.Equal(t, "base-server-491048210-3fv8v", k8p.Items[0].Metadata.Name)
	assert.Equal(t, "devenv", k8p.Items[0].Metadata.Namespace)
	assert.Equal(t, "base-server", k8p.Items[0].Metadata.Labels.Qcloud_app)
	assert.Equal(t, "Running", k8p.Items[0].Status.Phase)
}
